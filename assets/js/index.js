...
$(document).ready(function () {
  ...
  $(".btn-regadvise").click(function () {
    ...
    let templateParams = {
      from_name: name.val(),
      message: `Số điện thoại : ${phone.val()} - Địa chỉ : ${
        address.val() || "Chưa xác định"
      } - Thương hiệu : ${brand.val() || "Chưa xác định"}`,
    };
  ...
  var options = {
    strings: [
      "Vận hành APP ngay khi Spa không có <i> nhân viên phụ trách hình ảnh, nội dung.</i>",
    ],
    typeSpeed: 30,
    loop: true,
  };
  ...
  function e(e) {
    ...
    if (0 == e) return i;
    for (var t = 0; t <= e; t++)
      i += $(".header-fixed-search-index").eq(t).width();
    return i;
  }

  function i(e) {
    for (var i = 0, t = 0; t <= e; t++)
      i += $(".header-fixed__menu-detail > ul > li").eq(t).width();
    return i;
  }
  ...
  function a(e) {
    for (var i = 0, t = 0; t <= e; t++)
      i += $(".header-top__menu-detail > ul > li").eq(t).width();
    return i;
  }
  window.scrollY >= 750
  ...
  function l() {
    $(
      ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-freemes"
    ).html("GỬI tin nhắn <br> miễn phí</br>"),
      $(
        ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-voucher"
      ).html("Quản lý <br> voucher/coupon</br>"),
      $(
        ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-online"
      ).html("Mua hàng <br> Online</br>"),
      $(
        ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-book"
      ).html("Đặt lịch <br> trực tuyến</br>"),
      $(
        ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-qltlt"
      ).html("Quản lý <br> Thẻ Liệu trình</br>"),
      $(
        ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-connect"
      ).html("Kết nối <br> fanpage chat</br>"),
      $(
        ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-login"
      ).html("Đăng nhập bằng <br> QRcode</br>"),
      $(
        ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-foget"
      ).html("Quên mật khẩu <br> qua SMS</br>"),
      $(
        ".review-app__slider .owl-item .review-app__slider-title .review-app__slider-title-table"
      ).html("Thống kê <br> sử dụng</br>");
  }
  ...
  $(window).scroll(function (e) {
    ...
    i > r
      ? window.scrollY >= 150 && $(".header-fixed").addClass("show")
      : window.scrollY < 150 && $(".header-fixed").removeClass("show"),
      (r = i);
  }),
    ...
    $(".topleft-view-more").click(function () {
      $(".review-app__topleft p").fadeIn(400),
        $(".review-app__topleft h3")
          .html("APP KHÁCH HÀNG")
          .css("color", "#404040"),
        $(".review-app__topleft .review-app_tag").html(
          "Màu sắc & Thương hiệu riêng"
        ),
        $(this).hide();
    }),
    $(".review-app__slider-item").hover(
      function () {
        $(this).find(".app-img-after").addClass("hide-img"),
          $(this).find(".app-img-before").addClass("show-img");
      },
      function () {
        $(this).find(".app-img-after").removeClass("hide-img"),
          $(this).find(".app-img-before").removeClass("show-img");
      }
    ),
    $(".review-app__slider-item").click(function () {
      if ($(this).attr("data-title").length >= 5) {
        $(".modal-review-app img").attr("src", $(this).attr("data-title")),
          $(".modal-view-next").attr(
            "data-id",
            parseInt($(this).attr("data-id")) + 1
          ),
    ...
    $(".shadow-behind").click(function () {
      $(".modal-review-app").removeClass("show-img"),
        $(".shadow-behind").removeClass("show-img");
    }),
    ...
    window.outerWidth > 440
      ? $(".introduce-box__title .introduce-box__des-software").html(
          "Kết nối phần mềm"
        )
      : window.outerWidth > 576
      ? ($("#email .table-app").html("Phí thuê tài khoản AppleStore / CHPlay"),
        $(".header__item filter__link--number:first-child").html(
          "NĂM ĐẦU TIÊN"
        ),
        $(".header__item filter__link--number:last-child").html(
          "NĂM TIẾP THEO"
        ))
      : window.outerWidth > 1024 &&
        $("#main-footer .row .footer-title span").html(
          "Đối tác không thể thiếu<br> khi bạn kinh doanh</br> SPA / Thẩm mỹ viện"
        ),
    window.outerWidth <= 576 &&
      ($("#email .table-app").html("Phí thuê tài khoản app"),
      $(".table-header .filter__link--number:first-child").html("NĂM ĐẦU"),
      $(".table-header .filter__link--number:last-child").html("NĂM TIẾP")),
    window.outerWidth <= 440
      ? $(".introduce-box__title .introduce-box__des-software").html(
          "Kết nối phần mềm trực tiếp"
        )
      : window.outerWidth <= 1024
      ? ($("#main-footer .row .footer-title span").html(
          "Đối tác không thể thiếu khi bạn kinh doanh SPA / Thẩm mỹ viện"
        ),
        $(".main-head__title .review-app_tag").html(
          "Ưu đãi 80% | Tặng Canva Pro"
        ),
        l())
      : window.outerWidth <= 1366
      ? ($(".main-head__title .review-app_tag").html(
          "Ưu đãi 80% | Tặng tài khoản Canva Pro"
        ),
        l())
      : ($(".main-head__title .review-app_tag").html(
          "Ưu đãi lên đến 80% | Tặng tài khoản Canva Pro"
        ),
        s()),
    $(window).resize(function () {
      window.outerWidth > 440
        ...
        window.outerWidth > 576 &&
          ($("#email .table-app").html(
            "Phí thuê tài khoản AppleStore / CHPlay"
          ),
          $(".header__item .filter__link--number:first-child").html(
            "NĂM ĐẦU TIÊN"
          ),
    ...
    $(".review-app .review-app__topleft .review-app_tag").addClass(
      "show translate-default"
    ),
...
var EzsPrice = {
  init: () => {
    $(".select-pm-cs .dropdown-item, .select-pm-year .dropdown-item").click(
      function () {
  ...
  onChangePM: (_this) => {
    ...
    elDropdown
      .parents(".module-ezs")
      .find(type === "cs" ? ".val-cs-pmg" : ".val-year-pmg")
      .text(val);
    EzsPrice.getTotalPM();
  },
  onChangeAPP: (_this) => {
    ...
    $(".total-app")
      .attr("data-totalapp", valPrice)
      .html(`${EzsPrice.formatVND(valPrice)}₫`);
    if (valPrice > 0) {
  ...
  getTotalPM: () => {
    ...
    $(".total-pm")
      .attr("data-totalcs", total)
      .html(`${EzsPrice.formatVND(total)}₫`);
    EzsPrice.getTotalBasic();
  },
  getTotalBasic: () => {
    const total =
      Number($(".total-pm").attr("data-totalcs")) +
      Number($(".total-app").attr("data-totalapp"));
...
var EzsChangePrice = {
  init: () => {
    ...
    $(".domain-item").click((e) => {
      ...
      $(".domain-first")
        .html(EzsChangePrice.formatVND(Number(dataset.valueFirst)))
        .attr({
          "data-price-frist": dataset.valueFirst,
          "data-price-year-old": dataset.valueFirst,
        });
      $(".domain")
        .html(EzsChangePrice.formatVND(Number(dataset.value)))
        .attr({
  ...
  render: () => {
    ...
    elPriceFirst.html(
      EzsChangePrice.formatVND(
        EzsChangePrice.getTotal("[data-price-frist]", "data-price-frist")
      )
    );
    elPrice.html(
      EzsChangePrice.formatVND(
        EzsChangePrice.getTotal("[data-price]", "data-price")
      )
    );
    elPriceYearOld.html(
      EzsChangePrice.formatVND(
        EzsChangePrice.getTotal("[data-price-year-old]", "data-price-year-old")
      )
    );
    elPriceOld.html(
      EzsChangePrice.formatVND(
        EzsChangePrice.getTotal("[data-price-old]", "data-price-old")
      )
    );
  },
  getTotal: (el, attr) => {
    ...
    if (elmItem.length > 0 && elmItem.hasClass("customer-main-set")) {
      ...
      for (let [index, elm] of ListItem.entries()) {
        if (index > minDelete && index < maxDelete) {
          ListImg.push({
            Url: EzsListCustomer.getUrlImage(
              $(elm).find(".customer-charactor__box-detail")
            ),
...
var EzsImageMarker = {
  ...
  MarkerOne: () => {
    ...
    const data = [
      {
        ...
        content:
          "Bạn có thể tìm kiếm các thông tin về sản phẩm ( Mỹ phẩm ) & Dịch vụ",
        className: "green",
        pos: {
          x: 32,
          y: 76,
      ...
      },
      {
        ...
        content:
          "Banner các chương trình ưu đãi, dịch vụ mới - HOT, các sự kiện quan trọng trong SPA",
        className: "green",
        pos: {
          x: 32,
          y: 155,
      ...
      },
      {
        ...
        content:
          "Giúp người dùng ( Khách hàng truy cập nhanh đến các nội dung chính ), có thể thay đổi theo nhu cầu của SPA",
        className: "green",
        pos: {
          x: 32,
          y: 327,
      ...
      {
        title:
          `${windowsize < 1200 ? "4. " : ""}` + "Danh sách các dịch vụ Sale",
    ...
    $("#add_pos_marker").click(function () {
      $(imageMarker).trigger("add_marker", {
        title: "adadad",
        content:
          "Content for mock marker should be a bit longer, longer, longer... ok that`s it.",
        className: "green",
      });
    });
    $("#save").click(function () {
  ...
  onChangOwl: (elm) => {
    var offset = 0;
    let arrElm = document.querySelectorAll(
      `${elm} .active.center [data-toggle='popover']`
    );
...
const EzsListen = {
  ...
  getListen: () => {
    $.get("https://ezs.vn/wp-json/wp/v2/categories/15", function ({ acf }) {
  ...
  renderListen: (data) => {
    const myAudio = $(
      `<audio class="react-audio-player w-100" controls="" id="audio-listen" preload="metadata" controlslist="nodownload" src="${data.file_mp3}" title="${data.file_mp3}"><p>Your browser does not support the <code>audio</code> element.</p></audio>`
    );
